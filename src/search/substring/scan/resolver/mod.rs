...
pub(in crate::search::substring::scan) use gallop_seek::GallopSeek;
pub(in crate::search::substring::scan) use linear_seek::LinearSeek;
...
pub(in crate::search::substring::scan) trait Resolver<'a>:
    Sized
{
...
#[cfg(test)]
pub(in crate::search::substring::scan) fn expected_rows<O: Offset>(
    mask: &[u64],
    row_offsets: &[O],
) -> Vec<usize> {
