...
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
pub(in crate::search::prefilter::scan) use eq_or::EqOr;
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
pub(in crate::search::prefilter::scan) use nibble_n8::{MAX_BATCHES, NibbleN8, PER_BATCH};
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
pub(in crate::search::prefilter::scan) use range::Range;
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
pub(in crate::search::prefilter::scan) use shared::available as simd_available;
pub(in crate::search::prefilter::scan) use table::Table;

/// Bit `i` of `bits` is set iff the cover admits `codes[i]`. See `README.md`.
pub(in crate::search::prefilter::scan) trait Matcher:
    Sized
{
